...
const Himachal = () => {
    ...
    const navLinks = [
        { to: "/HimachalPradeshOverview", icon: <AiFillAppstore className='text-2xl lg:text-[28px]' />, text: "Overview" },
        { to: "/HimachalPradeshCities", icon: <LiaBrushSolid className='text-2xl lg:text-3xl' />, text: "Cities" },
        { to: "/HimachalPradeshGallery", icon: <FaImage className='text-2xl lg:text-[26px]' />, text: "Gallery" }
    ];
                            ...
                            <div className='grow bg-transparent md:flex flex-col justify-between my-1 md:my-0 rounded-[12px] font-SulphurPoint'>
                                <div className='my-2 md:my-0 bg-[#FFFFFF] rounded-xl'>
                                    <div className='flex md:flex-col justify-between items-center md:items-start p-2 md:p-1'>
                                        <h4 className='font-bold text-[#2D2D2D] md:text-[#A21D3C] text-xl md:text-2xl lg:text-3xl xl:text-4xl'>Himachal Pradesh</h4>
