                        ...
                        {index === images.length - 1 ? (
                            <div className='relative'>
                                ...
                                <div className='bg-[#dbe4e7]s absolute left-0 top-0 right-0 bottom-0 flex justify-center items-center'>
                                    <Link to="/gallery/id7" className='rounded-lg w-fit px-2 py-[2px] md:py-1 lg:py-2 lg:px-4 bg-[#F5F5F5] shadow-portfolioShowMore flex items-center justify-center gap-x-1 font-SulphurPoint font-bold text-base lg:text-xl text-[#2D2D2D] cursor-pointer'>
                                        <p>+40 more </p>
