...
const BestPlaceCard = ({image, place, city,state,  rating}) => {
    return (
            ...
            <div className='w-full px-2 relative flex flex-col justify-center md:block'>
                ...
                <div className='flex justify-between'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <h2 className='font-SulphurPoint font-bold text-lg xs:text-xl md:text-[28px] lg:text-[32px] text-[#2D2D2D]'>{state}</h2>
                    </div>
