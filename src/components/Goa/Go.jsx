...
const Go = () => {
    // Define an array of objects representing the links and icons
    const links = [
        {
            to: '/GoaOverview',
            icon: AiFillAppstore,
                            ...
                            <div className='grow bg-transparent md:flex flex-col justify-between my-1 md:my-0 rounded-[12px] font-SulphurPoint'>
                                <div className='my-2 md:my-0 bg-[#FFFFFF] rounded-xl'>
                                    <div className='flex md:flex-col justify-between items-center md:items-start p-2 md:p-1'>
                                        <h4 className='font-bold text-[#2D2D2D] md:text-[#A21D3C] text-xl md:text-2xl lg:text-3xl xl:text-4xl'>Goa</h4>
                                ...
                                <div className='bg-[#FFFFFF] md:bg-[#F3EFEF] rounded-[12px] overflow-hidden flex justify-between items-center md:gap-4'>
                                    {links.map(({ to, icon: Icon, label }, index) => (
                                        ...
                                        >
                                            <Icon className='text-2xl lg:text-[28px]'/>
                                            <p className='font-DMSans text-base lg:text-lg xl:text-xl'>{label}</p>
                                        </NavLink>
                                    ))}
                                </div>
                            </div>
