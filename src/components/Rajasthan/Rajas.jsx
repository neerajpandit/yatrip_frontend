...
const Rajas = () => {
    // Array of navigation links with icons and paths
    const navLinks = [
        {
            icon: AiFillAppstore,
            text: "Overview",
            path: "/RajasthanOverview"
        },
        {
            icon: LiaBrushSolid,
            text: "Cities",
            path: "/RajasthanCities"
        },
        {
            icon: FaImage,
            text: "Gallery",
            path: "/RajasthanGallery"
        }
    ];
                            ...
                            <div className='grow bg-transparent md:flex flex-col justify-between my-1 md:my-0 rounded-[12px] font-SulphurPoint'>
                                <div className='my-2 md:my-0 bg-[#FFFFFF] rounded-xl'>
                                    <div className='flex md:flex-col justify-between items-center md:items-start p-2 md:p-1'>
                                        <h4 className='font-bold text-[#2D2D2D] md:text-[#A21D3C] text-xl md:text-2xl lg:text-3xl xl:text-4xl'>Rajasthan</h4>
                                ...
                                <div className='bg-[#FFFFFF] md:bg-[#F3EFEF] rounded-[12px] overflow-hidden flex justify-between items-center md:gap-4'>
                                    ...
                                    {navLinks.map((link, index) => (
                                        ...
                                        >
                                            <link.icon className='text-2xl lg:text-[28px]' />
